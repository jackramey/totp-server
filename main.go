...
func main() {
	...
	if err := InitDatabase(dbClient); err != nil {
...
func RegisterHandler(c echo.Context) error {
	...
	if err := InsertUser(dbClient, payload.Username, secret); err != nil {
...
func VerifyHandler(c echo.Context) error {
	...
	secret, err := GetSecretByUsername(dbClient, payload.Username)
	if err != nil {
	...
	if err := UpdateVerificationStatus(dbClient, payload.Username); err != nil {
